                ...
                self.oauth.getOAuthAccessToken(
                    ...
                    function ( error, oauth_access_token, oauth_access_token_secret, results ) {
                        ...
                        if ( error ) {
                            ...
                            // execute GET request.
                            self.oauth.get( url, oauth_access_token, oauth_access_token_secret, callback );
                        }
                    }
                );
            }
                ...
                self.oauth.getOAuthAccessToken(
                    ...
                    function ( error, oauth_access_token, oauth_access_token_secret, results ) {
                        ...
                        if ( error ) {
                            ...
                            // execute GET request.
                            self.oauth.post( self.rootUrl + resourceName, oauth_access_token, oauth_access_token_secret,
                                params, 'application/json', callback )
                        }
                    }
                );
